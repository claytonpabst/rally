...
class GameInfo extends React.Component {
    ...
    handleDatePicked = date => {
        ...
        this.setState({ dateTime: dateString, date: dateDisplay, time: time, UTCDateTime: UTC })
        ...
        return (
            ...
            <View style={s.formAreaWrapper}>
                ...
                <Text>Time to respond</Text> */}
                    {this.state.dateTime.length > 1 && this.state.location.length > 1 && this.state.groupSize > 1 ?
